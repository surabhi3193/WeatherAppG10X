...
import com.example.weatherappgxx.model.Daily
import com.example.weatherappgxx.utils.Common
import kotlin.math.roundToInt

class DailyAdapter(private val mList: ArrayList<Daily>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.rv_daily_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvDate.text = ItemsViewModel?.dt?.let { Common.getDate(it) }
        holder.tvWeather.text =forecast
        holder.tvTemp.text = ItemsViewModel?.temp?.day?.roundToInt().toString()+ "°C"
